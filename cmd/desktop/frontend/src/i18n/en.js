export default {
    ...
    modal: {
        ...
        transformer: 'Transformer',
        transformerAuto: 'Auto-detect (Recommended)',
        transformerHelp: 'Auto-detect chooses the provider and upstream protocol from URL, model, and probe results',
        model: 'Model',
        modelPlaceholder: 'e.g., claude-sonnet-4-5-20250929',
        modelHelp: 'Optional: Override the model specified in requests',
        modelHelpAuto: 'A model name helps detect the provider, e.g. kimi-k2.6',
    ...
    welcome: {
        ...
        message: 'ccNexus is an API resource management system for Claude Code, Codex CLI, and OpenAI-compatible clients, with smart endpoint rotation built in.',
        features: 'Features',
        feature1: 'Centralized management for API endpoints, models, keys, and Token Pools',
        feature2: 'Support for Claude, OpenAI, Responses, Gemini, DeepSeek, and Kimi formats',
    ...
    tips: [
        ...
        'Tip: Currently supports Claude, OpenAI, Gemini, DeepSeek and Kimi API formats',
        'Tip: Use different transformers (Claude/OpenAI/Gemini/DeepSeek/Kimi) for different endpoints',
