export default {
    ...
    modal: {
        ...
        transformer: '转换器',
        transformerAuto: '自动识别（推荐）',
        transformerHelp: '自动识别会根据 URL、模型名和探测结果选择正确协议',
        model: '模型',
        modelPlaceholder: '例如：claude-sonnet-4-5-20250929',
        modelHelp: '可选：覆盖请求中指定的模型',
        modelHelpAuto: '填写模型名可帮助自动识别 Provider，例如 kimi-k2.6',
        ...
        modelHelpDeepSeek: '指定 DeepSeek 模型（OpenAI Chat 兼容）',
        modelHelpKimi: '指定 Kimi/Moonshot 模型（OpenAI Chat 兼容）',
        thinking: '推理',
        thinkingLow: '低',
        thinkingMedium: '中',
        thinkingHigh: '高',
        thinkingXHigh: '超高',
        thinkingMax: 'Max',
        thinkingProviderDefault: '上游默认',
        thinkingHelp: '为支持的模型启用端点级推理，并选择推理强度。',
    ...
    welcome: {
        ...
        message: 'ccNexus 是面向 Claude Code、Codex CLI 和 OpenAI 兼容客户端的 API 资源管理系统，也是一款智能端点轮换代理。',
        features: '功能特性',
        feature1: '集中管理 API 端点、模型、密钥和 Token Pool',
        feature2: '支持 Claude、OpenAI、Responses、Gemini、DeepSeek 和 Kimi API 格式',
    ...
    tips: [
        ...
        '小贴士：当前支持 Claude、OpenAI、Gemini、DeepSeek 和 Kimi API 格式',
        '小贴士：可以为不同端点使用不同的转换器（Claude/OpenAI/Gemini/DeepSeek/Kimi）',
        '小贴士：点击端点的"切换"按钮可以手动指定默认端点',
