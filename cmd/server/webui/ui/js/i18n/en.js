export default {
    ...
    endpoints: {
        ...
        reasonUpstreamError: 'Upstream unavailable',
        reasonStreamError: 'Streaming failed',
        reasonNetworkError: 'Network error',
        reasonAuthFailed: 'Authentication failed',
        reasonTokenUnavailable: 'Token unavailable',
        reasonConfigError: 'Configuration error',
    ...
    testing: {
        ...
        tokenUpdated: 'Credential token updated',
        credentialDeleted: 'Credential deleted',
        endpointModelAdded: 'Model added',
        endpointModelEnabled: 'Model enabled',
        endpointModelDisabled: 'Model disabled',
        endpointModelVerifyQueued: 'Model verification queued',
        endpointModelsDiscovered: 'Discovered {count} models',
        endpointModelDeleted: 'Model deleted',
        urlCopied: 'URL copied'
    },
    transformers: {
        auto: 'Auto-detect',
