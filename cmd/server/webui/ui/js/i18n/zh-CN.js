export default {
    ...
    endpoints: {
        ...
        available: '可用',
        unavailable: '不可用',
        reasonQuotaExhausted: '额度不足',
        reasonRateLimited: '请求限流',
        reasonUpstreamError: '上游不可用',
        reasonStreamError: '流式响应失败',
        reasonNetworkError: '网络错误',
        reasonAuthFailed: '认证失败',
        reasonTokenUnavailable: 'Token 不可用',
        reasonConfigError: '配置错误',
    ...
    testing: {
        ...
        tokenUpdated: '凭证令牌已更新',
        credentialDeleted: '凭证已删除',
        endpointModelAdded: '模型已添加',
        endpointModelEnabled: '模型已启用',
        endpointModelDisabled: '模型已禁用',
        endpointModelVerifyQueued: '模型验证已加入队列',
        endpointModelsDiscovered: '已发现 {count} 个模型',
        endpointModelDeleted: '模型已删除',
        urlCopied: 'URL 已复制'
    },
    transformers: {
        auto: '自动识别',
